...
import ir.duniject.wikipeddia.Adapter.TrendExplore
import ir.duniject.wikipeddia.Data.ItemPost
import ir.duniject.wikipeddia.databinding.FragmenttrendBinding
...
class Fragmenttrend:Fragment() , ItemEvents {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val myAdapter = TrendExplore(dataTrend , this)
        binding.recyclerTernd.layoutManager = LinearLayoutManager(context , RecyclerView.VERTICAL , false)
        binding.recyclerTernd.adapter = myAdapter
